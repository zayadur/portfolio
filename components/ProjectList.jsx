        ...
        {projectData.map(({ id, title, stack }) => (
          <div key={id} class="group relative">
            <div class="relative w-full h-90 rounded-lg group-hover:opacity-75 sm:aspect-w-2 sm:aspect-h-1 sm:h-90 lg:aspect-w-1 lg:aspect-h-1 cursor-pointer ease-in-out duration-200">
              <p class="font-bold my-3 text-2xl text-center cursor-pointer">{title}</p>
              ...
              <p class="text-lg text-center">{stack}</p>
            </div>
          </div>
        ))}
      </section>
      <hr />
      <h1 class="my-6 flex justify-center text-4xl font-black">video</h1>
      <section class="my-6 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-4 lg:gap-x-6">
        <div class="group relative">
          <div class="relative w-full h-90 rounded-lg group-hover:opacity-75 sm:aspect-w-2 sm:aspect-h-1 sm:h-90 lg:aspect-w-1 lg:aspect-h-1 cursor-pointer ease-in-out duration-200">
            <p class="font-bold my-3 text-2xl text-center cursor-pointer">Volume Warning</p>
        ...
        <div class="group relative">
          <div class="relative w-full h-90 rounded-lg group-hover:opacity-75 sm:aspect-w-2 sm:aspect-h-1 sm:h-90 lg:aspect-w-1 lg:aspect-h-1 cursor-pointer ease-in-out duration-200">
            <p class="font-bold my-3 text-2xl text-center cursor-pointer">Let's Do It</p>
        ...
        <div class="group relative">
          <div class="relative w-full h-90 rounded-lg group-hover:opacity-75 sm:aspect-w-2 sm:aspect-h-1 sm:h-90 lg:aspect-w-1 lg:aspect-h-1 cursor-pointer ease-in-out duration-200">
            <p class="font-bold my-3 text-2xl text-center cursor-pointer">Great Value Trash Bag</p>
